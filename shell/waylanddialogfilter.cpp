...
WaylandDialogFilter::WaylandDialogFilter(ShellCorona *c, PlasmaQuick::Dialog *parent)
    : QObject(parent),
      m_dialog(parent)
{
...
void WaylandDialogFilter::install(PlasmaQuick::Dialog *dialog, ShellCorona *c)
{
