...
class WaylandDialogFilter : public QObject
{
    Q_OBJECT
public:
    WaylandDialogFilter(ShellCorona *c, PlasmaQuick::Dialog *parent = 0);
    ~WaylandDialogFilter();

    static void install(PlasmaQuick::Dialog *dialog, ShellCorona *c);
...
private:
    ...
    QPointer<PlasmaQuick::Dialog> m_dialog;
